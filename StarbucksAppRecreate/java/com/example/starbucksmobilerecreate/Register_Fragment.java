...
public class Register_Fragment extends Fragment {
                             ...
                             Bundle savedInstanceState)
    {
       ...
       //initialize widgets in fragment
        mSignUpButton = (Button)view.findViewById(R.id.register_button);
        mFname_EditText = (EditText)view.findViewById(R.id.register_fname_edit_text);
        mLname_EditText = (EditText)view.findViewById(R.id.register_lname_edit_text);
        mEmail_EditText = (EditText)view.findViewById(R.id.register_email_edit_text);
        mPassword_EditText = (EditText)view.findViewById(R.id.register_password_edit_text);
        mCheckBox_Terms = (CheckBox)view.findViewById(R.id.register_checkbox1);
        mCheckBox_Emails = (CheckBox)view.findViewById(R.id.register_checkbox2);
