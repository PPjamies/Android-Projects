...
//This class will handle main and fragments
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //initialize widgets
        mFruitButton = (Button) findViewById(R.id.fruit_button);
        mFlowerButton = (Button) findViewById(R.id.flower_button);
        mAnimalButton = (Button) findViewById(R.id.animal_button);
